...
{
    public $daftarProduk = []; // menyimpan produk

    // menerima objek tipe Produk
    // mengisi produk baru ke dalam array
    public function tambahProduk(Produk $produk)
    {
        $this->daftarProduk[] = $produk; // menambahkan elemen baru kedalam array
    }
